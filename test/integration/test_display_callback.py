...
def executor(tmp_path, request):
    ...
    envvars['DISTRONODE_PYTHON_INTERPRETER'] = 'auto_silent'
...
@pytest.mark.parametrize('envvars', [
    {'DISTRONODE_CALLBACK_PLUGINS': os.path.join(HERE, 'callback')},
...
def test_resolved_actions(executor, playbook, skipif_pre_distronode212):
    ...
    assert events[2]["event_data"]["resolved_action"] == "distronode.builtin.shell"
...
def test_output_when_given_invalid_playbook(tmp_path):
    ...
    #
    #   https://github.com/distronode/distronode-runner/issues/29
    #
    # There was a lack of output by runner when a playbook that doesn't exist
    # is provided.  This was fixed in this PR:
    #
    #   https://github.com/distronode/distronode-runner/pull/34
    #
...
def test_output_when_given_non_playbook_script(tmp_path):
    ...
    #
    #   https://github.com/distronode/distronode-runner/pull/256
    #
    ...
    #
    #   https://github.com/AlanCoding/distronode-runner-examples/tree/master/non_playbook/sleep_with_writes
    private_data_dir = str(tmp_path)
