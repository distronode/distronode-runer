...
class Runner(object):
            ...
            try:
                ...
                try:
                    ...
                    if self.config.check_job_event_data:
                        raise DistronodeRunnerException(msg)
    ...
    def run(self):
        ...
        if self.config.containerized:
            ...
            # option expecting should have already been written in distronode_runner.runner_config
    ...
    def events(self):
        ...
        while not os.path.exists(event_path):
            ...
            if wait_time.total_seconds() > 60:
                raise DistronodeRunnerException("events directory is missing: %s" % event_path)
