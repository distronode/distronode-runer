    ...
    "container_group": (
        (
            ...
            dict(
                ...
                default="quay.io/distronode/distronode-runner:devel",
...
class DistronodeRunnerArgumentParser(argparse.ArgumentParser):
    def error(self, message):
        ...
        super(DistronodeRunnerArgumentParser, self).error(message)
    ...
    if vargs.get('role'):
        ...
        if vargs.get('inventory'):
            ...
            if not os.path.exists(inventory_file):
                raise DistronodeRunnerException('location specified by --inventory does not exist')
        ...
        output.debug('setting DISTRONODE_ROLES_PATH to %s' % roles_path)
