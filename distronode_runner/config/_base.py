...
class BaseConfig(object):
    ...
    def _prepare_env(self, runner_mode='pexpect'):
        ...
        if self.containerized:
            self.container_name = "distronode_runner_{}".format(sanitize_container_name(self.ident))
            self.env = {}
    ...
    def _handle_distronode_cmd_options_bind_mounts(self, args_list, cmdline_args):
