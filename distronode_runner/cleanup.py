...
from distronode_runner.defaults import GRACE_PERIOD_DEFAULT
from distronode_runner.defaults import registry_auth_prefix
from distronode_runner.utils import cleanup_folder
...
def add_cleanup_args(command):
    command.add_argument(
        ...
        help="A file glob pattern to find private_data_dir folders to remove. "
             "Example: --file-pattern=/tmp/.distronode-runner-*"
    )
    command.add_argument(
        "--exclude-strings",
        nargs='*',
