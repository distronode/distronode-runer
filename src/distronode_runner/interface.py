...
def run(**kwargs):
    ...
    :param str container_image: Container image to use when running an distronode task
...
def get_plugin_docs(plugin_names, plugin_type=None, response_format=None, snippet=False, playbook_dir=None, module_path=None, **kwargs):
    ...
    :param container_image: Container image to use when running an distronode task
